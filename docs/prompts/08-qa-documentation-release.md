...
Exécuter PHP lint, PHPStan, tests unitaires et intégration, activation/désactivation/réactivation, puis générer et rendre visuellement les deux PDF sur des jeux complets. Finaliser README, cahier des charges, `ChangeLog.md` 1.0.0, onglet À propos et matrice de tests manuels.
