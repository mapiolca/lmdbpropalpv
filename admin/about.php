...
$rows = array(
	...
	array($langs->trans('LmdbPropalPVMainFeatures'), $langs->trans('FinancialStudyPV').', '.$langs->trans('LmdbPropalPVModelWithPictures').', '.$langs->trans('LmdbPropalPVModelWithoutPictures')),
